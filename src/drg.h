...
////////////////////////////////////////////////////////////////////////////////
///
/// Directed relation graph (DRG) method for reducing detailed chemical mechanisms 
/// to skeletal mechanisms. Subsets of species are selected for a given chemical state
/// and these subsets are combined over multiple chemical states evaluated from 
/// PSR S-curves for a range of stoichiometries.
///
////////////////////////////////////////////////////////////////////////////////
...
class DRG {
    ...
    private: 
        ...
        size_t nsp;                  ///< number of chemical species in the detailed mechanism
        size_t nrx;                  ///< number of reactions in the detailed mechanism
        ...
        double eps;                  ///< tolerance used for removing species
    ...
    private: 
        Eigen::SparseMatrix<double> RCc;                  ///< reaction coefficients column major; nsp by nrx
        Eigen::SparseMatrix<double,Eigen::RowMajor> RCr;  ///< reaction coefficients row major; nsp by nrx
